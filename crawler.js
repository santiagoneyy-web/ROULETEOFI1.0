/**
 * crawler.js — Cloud-Stealth Scraper (Ofi 1.0)
...
async function startStealthAxios() {
    console.log(`\n☁️ Starting CLOUD-STEALTH Scraper (Ofi 1.0) for Table ${TABLE_ID}`);
    let lastKnownEventId = null;

    const poll = async () => {
        try {
            // Mimic a real browser hitting the API through the casino.org proxy
